#ifndef mulle_objc_inet_foundation_include_h__
#define mulle_objc_inet_foundation_include_h__
...
/* This is a central include file to keep dependencies out of the library
   ...
   not "MulleObjCInetFoundation-include.h" to keep the #include statements in the
