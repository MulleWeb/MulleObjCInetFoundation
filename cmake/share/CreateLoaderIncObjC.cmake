if( NOT __CREATE_LOADER_INC_OBJC_CMAKE__)
   ...
   if( CREATE_OBJC_LOADER_INC)
      #
      # _1_MulleObjCInetFoundation is an object library (a collection of files).
      # _2_MulleObjCInetFoundation is the loader with OBJC_LOADER_INC.
      # Produce a static library _3_MulleObjCInetFoundation from _1_MulleObjCInetFoundation
      ...
      add_library( "_3_MulleObjCInetFoundation" STATIC
         $<TARGET_OBJECTS:_1_MulleObjCInetFoundation>
      )
      ...
      add_custom_command(
         ...
         COMMAND ${MULLE_OBJC_LOADER_TOOL}
                   ...
                   -c "${CMAKE_BUILD_TYPE}"
                   -o "${OBJC_LOADER_INC}"
                   $<TARGET_FILE:_3_MulleObjCInetFoundation>
                   ${INHERITED_OBJC_LOADERS}
         DEPENDS $<TARGET_FILE:_3_MulleObjCInetFoundation>
      ...
      add_dependencies( "_2_MulleObjCInetFoundation" __objc_loader_inc__)
   endif()
