if( NOT __EXECUTABLE_OBJC_CMAKE__)
   ...
   #
   set_target_properties( MulleObjCInetFoundation
   ...
   #
   add_custom_command(
     TARGET MulleObjCInetFoundation
     POST_BUILD
     COMMAND echo "Your executable \"$<TARGET_FILE:MulleObjCInetFoundation>\" is now ready to run"
     VERBATIM
   )
