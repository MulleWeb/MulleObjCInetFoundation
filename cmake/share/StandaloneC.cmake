if( NOT __STANDALONE_C_CMAKE__)
   ...
   if( STANDALONE)
      ...
      if( NOT STANDALONE_NAME)
         set( STANDALONE_NAME "MulleObjCInetFoundation-standalone")
      endif()
      set( STANDALONE_DEFINITIONS ${MULLE_OBJC_INET_FOUNDATION_DEFINITIONS})
      ...
      if( NOT STANDALONE_ALL_LOAD_LIBRARIES)
         set( STANDALONE_ALL_LOAD_LIBRARIES
            $<TARGET_FILE:MulleObjCInetFoundation>
...
MulleObjCInetFoundation-standalone.c with contents like this to it:
   int  ___mulle_objc_inet_foundation_unused__;
and everybody will be happy")
         ...
         add_dependencies( ${STANDALONE_NAME} MulleObjCInetFoundation)
         if( STARTUP_NAME)
